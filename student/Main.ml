...
(******************Test effet de bord***************)
let%test _ = ( getValeur (main "../../exemples/test1.mml") = NullValue)
let %test _= ( (string_of_mem (getMem (main "../../exemples/test1.mml")) = ("ref@1,2;ref@1,0;")))
let%test _ = ( getValeur (main "../../exemples/test2.mml") = IntegerValue 0)
let %test _= ( (string_of_mem (getMem (main "../../exemples/test2.mml")) = ("ref@1,0;")))
let %test _ = ( getValeur (main "../../exemples/test3.mml") = NullValue)
let %test _= ( (string_of_mem (getMem (main "../../exemples/test3.mml")) = ("ref@1,2;ref@2,2;ref@1,0;")))
let %test _ = ( getValeur (main "../../exemples/test4.mml") = IntegerValue 2)
let %test _= ( (string_of_mem (getMem (main "../../exemples/test4.mml")) = ("ref@1,2;ref@2,2;ref@1,0;")))
let %test _ = ( getValeur (main "../../exemples/test5.mml") = NullValue)
let %test _= ((string_of_mem (getMem (main "../../exemples/test5.mml")) = ("ref@1,3;ref@1,2;")))
let %test _= ( getValeur (main "../../exemples/test6.mml") = IntegerValue 4)
let %test _= ((string_of_mem (getMem (main "../../exemples/test6.mml")) = ("ref@1,3;")))
let %test _= (getValeur (main "../../exemples/test7.mml") = NullValue)
let %test _= ((string_of_mem (getMem (main "../../exemples/test7.mml")) = ("ref@1,11;ref@1,10;ref@1,9;ref@1,8;ref@1,7;ref@1,6;ref@1,5;ref@1,4;ref@1,3;ref@1,2;ref@1,1;")))
let %test _= (getValeur (main "../../exemples/test8.mml") = NullValue)
let %test _= ((string_of_mem (getMem (main "../../exemples/test8.mml")) = ("ref@1,12;ref@1,10;ref@1,8;ref@1,6;ref@1,4;ref@1,2;ref@1,1;")))
...
(*let%test _ = ( (let _val = getValeur (main "../../exemples/exemple-13.mml") in (print_endline (string_of_value _val));
		    _val) = (ErrorValue UndefinedExpressionError) )*)